...
pokemons_rotas = {
    ...
    "Sandshrew": "Encontre em Route 23, 11, 8, 4, ou 9",
    "Sandslash": "Evolui de Sandshrew no level 22 ou encontre em Unknown Dungeon ou Route 23",
    ...
    "Vulpix": "Cinnabar Island, ou Routes 8 ou 7",
    "Ninetales": "Evolui de Vulpix com Fire Stone",
    ...
    "Bellsprout": "Routes 6, 7, 12, 13, 14, 15, 24, ou 25",
    "Weepinbell": "Evolui de Bellsprout no level 21 ou encontre em Routes 12, 13, 14, ou 15",
    "Victreebel": "Evolui de Weepinbell com a Leaf Stone",
    ...
    "Slowpoke": "Pesque em Celadon City, Safari Zone, Cinnabar Island, Route 9 ou 10, ou ache-o em Seafoam Islands",
    "Slowbro": "Evolui de Slowpoke no level 37 ou encontre em Route 23, Unknown Dungeon, ou Seafoam Island",
    ...
    "Staryu": "Pesque em Routes 19, 20, 21, Cinnabar Island ou encontre em Seafoam Islands",
    "Starmie": "Evolui de Staryu com a Water Stone",
    ...
    "Magmar": "Encontre em Cinnabar's Mansion",
    "Pinsir": "Ganhe no Game Corner ou encontre em Safari Zone",
...
def criar_time(incluir_inicial=True):
    ...
    if incluir_inicial:
        ...
        time.append(inicial)
        del pokemons_rotas[inicial]

    # Adiciona os outros Pokémon aleatórios
    for _ in range(6 - len(time)):
        pokemon_aleatorio = random.choice(list(pokemons_rotas.keys()))
        time.append(pokemon_aleatorio)
        del pokemons_rotas[pokemon_aleatorio]
...
for pokemon in time_aleatorio:
    print(f"{pokemon} - Encontrado em: {pokemons_rotas.get(pokemon, '')}")
